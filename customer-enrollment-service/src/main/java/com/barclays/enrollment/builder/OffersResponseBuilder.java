 ...
 * 
 * import com.barclays.offers.model.CardVerifyResponse; import
 * com.barclays.offers.model.EnrollmentResponse; import
 * com.barclays.offers.model.OfferDetails; import
 * com.barclays.offers.model.OfferDetailsDao; import
 * com.barclays.offers.model.OffersDaoResponse; import
 * com.barclays.offers.model.OffersResponse; import
 * com.barclays.offers.model.StatusBlock;
 * 
 * @Component public class OffersResponseBuilder {
 * 
 *//**
	 ...
	 *//*
		 * 
		 * public OffersResponse buildOffersResp(EnrollmentResponse enrollmentResp,
		 * CardVerifyResponse cardVerifyResp, OffersDaoResponse daoResp) {
		 * 
		 * // service response OffersResponse offersResponse = new OffersResponse();
		 * 
		 ...
		 * 
		 * StatusBlock statusBlock = new StatusBlock();
		 * statusBlock.setRespCode(respCode); statusBlock.setRespMsg(respMsg);
		 * 
		 * offersResponse.setStatusBlock(statusBlock); return offersResponse; }
		 * 
		 * }
		 */
